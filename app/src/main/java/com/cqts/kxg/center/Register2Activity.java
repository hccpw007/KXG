...
public class Register2Activity extends MyActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            channel = GetMetaInfo.getChannel(this);
        } catch (Exception e) {
        }
        InitView();
    }
    ...
    private void InitView() {
        ...
        if (!TextUtils.isEmpty(channel)&&!channel.equals("kxg") && channel.length() == 6) {
            register2_invite_et.setText(channel);
        }
