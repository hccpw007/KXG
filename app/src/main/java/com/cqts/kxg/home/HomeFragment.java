...
public class HomeFragment extends BaseFragment implements View.OnClickListener, RefreshLayout
        ...
        home_refresh.setRC(recyclerview, new RefreshLayout.TopOrBottom() {
            ...
            public void gotoBottom() {
                if (articleInfos.size() >= pageSize){
                    MyHttp.articleList(http, HomeAdapter.listType, 1, pageSize, pageNum, HomeFragment.this);
                }
            }
